        ...
        <footer class="py-5">
            <div class="row">
                ...
                <div class="col-md-5 offset-md-1 mb-3">
                    <h4>Contact Me</h4>
                    <h5>Phone: 608-317-8741</h5>
                    <h5>Email: cxavieryang@gmail.com</h5>
                    <div class="col-6 col-md-2 mb-3">
                        <a href="https://github.com/CX-Yang" class="mb-2">
                        ...
                        <a href="https://www.linkedin.com/in/chen-xavier-yang/" class="mb-2 ms-2">
